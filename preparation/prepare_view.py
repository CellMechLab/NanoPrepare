...
class Ui_radius(object):
    def setupUi(self, radius):
        ...
        self.geometry_label = QtWidgets.QLabel(self.Cantilever)
        self.geometry_label.setObjectName("geometry_label")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.geometry_label)
    ...
    def retranslateUi(self, radius):
        ...
        self.c_open.setItemText(1, _translate("radius", "jpk-fmap"))
        self.c_open.setItemText(2, _translate("radius", "jpk-force"))
        self.c_open.setItemText(3, _translate("radius", "Optics11 2019"))
        self.c_open.setItemText(4, _translate("radius", "Optics11 OLD"))
        self.c_open.setItemText(5, _translate("radius", "Nanosurf export"))
        self.c_open.setItemText(6, _translate("radius", "Easy TSV"))
        ...
        self.geometry.setItemText(3, _translate("radius", "Cone"))
        self.geometry.setItemText(4, _translate("radius", "Pyramid"))
        self.geometry.setItemText(5, _translate("radius", "Other"))
        self.geometry_label.setText(_translate("radius", "Tip Radius [nm]"))
